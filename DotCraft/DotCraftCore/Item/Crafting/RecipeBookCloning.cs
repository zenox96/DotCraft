...
///     
		public virtual bool matches(InventoryCrafting p_77569_1_, World p_77569_2_)
		{
			...
			for (int var5 = 0; var5 < p_77569_1_.SizeInventory; ++var5)
			{
				...
				if (var6 != null)
				{
					if (var6.Item == Items.written_book)
					{
						if (var4 != null)
						{
							return false;
					...
					{
						if (var6.Item != Items.writable_book)
						{
							return false;
						}
...
///     
		public virtual ItemStack getCraftingResult(InventoryCrafting p_77572_1_)
		{
			...
			for (int var4 = 0; var4 < p_77572_1_.SizeInventory; ++var4)
			{
				...
				if (var5 != null)
				{
					if (var5.Item == Items.written_book)
					{
						if (var3 != null)
						{
							return null;
					...
					{
						if (var5.Item != Items.writable_book)
						{
							return null;
						}
			...
			if (var3 != null && var2 >= 1)
			{
				...
				var6.TagCompound = (NBTTagCompound)var3.TagCompound.copy();
