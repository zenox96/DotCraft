...
namespace DotCraftCore.World.Biome
{
	...
	public class BiomeGenSavanna : BiomeGenBase
	{
		...
		{
			this.spawnableCreatureList.add(new BiomeGenBase.SpawnListEntry(typeof(EntityHorse), 1, 2, 6));
		...
		{
			return (WorldGenAbstractTree)(p_150567_1_.Next(5) > 0 ? field_150627_aC : this.worldGeneratorTrees);
		}
		...
		public virtual void decorate(World p_76728_1_, Random p_76728_2_, int p_76728_3_, int p_76728_4_)
		{
			...
			{
				int var6 = p_76728_3_ + p_76728_2_.Next(16) + 8;
				int var7 = p_76728_4_ + p_76728_2_.Next(16) + 8;
				int var8 = p_76728_2_.Next(p_76728_1_.getHeightValue(var6, var7) + 32);
		...
		public class Mutated : BiomeGenMutated
		{
			...
			public override void func_150573_a(World p_150573_1_, Random p_150573_2_, Block[] p_150573_3_, sbyte[] p_150573_4_, int p_150573_5_, int p_150573_6_, double p_150573_7_)
			{
			...
			public override void decorate(World p_76728_1_, Random p_76728_2_, int p_76728_3_, int p_76728_4_)
			{
