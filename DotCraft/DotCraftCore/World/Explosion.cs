...
namespace DotCraftCore.World
{
	...
	{
	/// <summary> whether or not the explosion sets fire to blocks around it  </summary>
		public bool isFlaming;

	/// <summary> whether or not this explosion spawns smoke particles  </summary>
	...
	/// <summary> A list of ChunkPositions of blocks affected by this explosion  </summary>
		public IList affectedBlockPositions = new ArrayList();
		private IDictionary field_77288_k = new Hashtable();
		private const string __OBFID = "CL_00000134";
...
///    
///     <summary> * Does the first part of the explosion (destroy blocks) </summary>
///     
		public virtual void doExplosionA()
		{
					...
					for (var5 = 0; var5 < this.field_77289_h; ++var5)
					{
						if (var3 == 0 || var3 == this.field_77289_h - 1 || var4 == 0 || var4 == this.field_77289_h - 1 || var5 == 0 || var5 == this.field_77289_h - 1)
						{
							...
							for (float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F)
							{
								...
								if (var25.Material != Material.air)
								{
			...
			this.affectedBlockPositions.AddRange(var2);
			...
			IList var9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, AxisAlignedBB.getBoundingBox((double)var3, (double)var5, (double)var7, (double)var4, (double)var29, (double)var30));
			Vec3 var31 = Vec3.createVectorHelper(this.explosionX, this.explosionY, this.explosionZ);

			for (int var11 = 0; var11 < var9.Count; ++var11)
			{
				Entity var32 = (Entity)var9[var11];
				...
				if (var13 <= 1.0D)
				{
					...
					var17 = var32.posY + (double)var32.EyeHeight - this.explosionY;
					...
					if (var33 != 0.0D)
					{
						...
						if (var32 is EntityPlayer)
						{
							this.field_77288_k.Add((EntityPlayer)var32, Vec3.createVectorHelper(var15 * var35, var17 * var35, var19 * var35));
						}
					}
				}
			}
...
///    
///     <summary> * Does the second part of the explosion (sound, particles, drop spawn) </summary>
///     
		public virtual void doExplosionB(bool p_77279_1_)
		{
			...
			if (this.isSmoking)
			{
				var2 = this.affectedBlockPositions.GetEnumerator();

				while (var2.MoveNext())
				{
					var3 = (ChunkPosition)var2.Current;
			...
			if (this.isFlaming)
			{
				...
				while (var2.MoveNext())
				{
					...
					if (var7.Material == Material.air && var24.func_149730_j() && this.explosionRNG.Next(3) == 0)
					{
		...
		public virtual IDictionary func_77277_b()
		{
			return this.field_77288_k;
		}

///    
///     <summary> * Returns either the entity that placed the explosive block, the entity that caused the explosion or null. </summary>
///     
		public virtual EntityLivingBase ExplosivePlacedBy
		{
			get
			{
				return this.exploder == null ? null : (this.exploder is EntityTNTPrimed ? ((EntityTNTPrimed)this.exploder).TntPlacedBy : (this.exploder is EntityLivingBase ? (EntityLivingBase)this.exploder : null));
			}
		}
	}
