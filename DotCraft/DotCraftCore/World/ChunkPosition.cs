namespace DotCraftCore.World
{
	...
	public class ChunkPosition
	{
		...
		public ChunkPosition(Vec3 p_i45364_1_) : this(MathHelper.floor_double(p_i45364_1_.xCoord), MathHelper.floor_double(p_i45364_1_.yCoord), MathHelper.floor_double(p_i45364_1_.zCoord))
		{
		}

		public override bool Equals(object p_equals_1_)
		{
			if (!(p_equals_1_ is ChunkPosition))
			{
				return false;
			}
			else
