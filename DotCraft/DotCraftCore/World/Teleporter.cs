...
namespace DotCraftCore.World
{
	...
	{
		private readonly WorldServer worldServerInstance;

	/// <summary> A private Random() function in Teleporter  </summary>
		private readonly Random random;

	/// <summary> Stores successful portal placement locations for rapid lookup.  </summary>
		private readonly LongHashMap destinationCoordinateCache = new LongHashMap();

///    
///     <summary> * A list of valid keys for the destinationCoordainteCache. These are based on the X & Z of the players initial
///     * location. </summary>
///     
		...
		public Teleporter(WorldServer p_i1963_1_)
		{
			...
			this.random = new Random(p_i1963_1_.Seed);
		}

///    
///     <summary> * Place an entity in a nearby portal, creating one if necessary. </summary>
///     
		public virtual void placeInPortal(Entity p_77185_1_, double p_77185_2_, double p_77185_4_, double p_77185_6_, float p_77185_8_)
		{
...
///    
///     <summary> * Place an entity in a nearby portal which already exists. </summary>
///     
		public virtual bool placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
		{
			short var9 = 128;
			double var10 = -1.0D;
			int var12 = 0;
			...
			if (this.destinationCoordinateCache.containsItem(var17))
			{
				...
				var13 = var20.posY;
				var14 = var20.posZ;
				var20.lastUpdateTime = this.worldServerInstance.TotalWorldTime;
				var19 = false;
			}
			else
			{
				for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
				{
					...
					for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
					{
						...
						for (int var26 = this.worldServerInstance.ActualHeight - 1; var26 >= 0; --var26)
						{
			...
			if (var10 >= 0.0D)
			{
				if (var19)
				{
					this.destinationCoordinateCache.add(var17, new Teleporter.PortalPosition(var12, var13, var14, this.worldServerInstance.TotalWorldTime));
					this.destinationCoordinateKeys.Add(Convert.ToInt64(var17));
				}
				...
				int var30 = p_77184_1_.TeleportDirection;
				...
				if (var50 > -1)
				{
					...
					bool var36 = !this.worldServerInstance.isAirBlock(var12 + var32 + var34, var13, var14 + var33 + var35) || !this.worldServerInstance.isAirBlock(var12 + var32 + var34, var13 + 1, var14 + var33 + var35);
					bool var37 = !this.worldServerInstance.isAirBlock(var12 + var32, var13, var14 + var33) || !this.worldServerInstance.isAirBlock(var12 + var32, var13 + 1, var14 + var33);
		...
		public virtual bool makePortal(Entity p_85188_1_)
		{
			sbyte var2 = 16;
			double var3 = -1.0D;
			...
			for (var13 = var5 - var2; var13 <= var5 + var2; ++var13)
			{
				...
				for (var16 = var7 - var2; var16 <= var7 + var2; ++var16)
				{
					...
					for (var19 = this.worldServerInstance.ActualHeight - 1; var19 >= 0; --var19)
					{
								...
								for (var23 = 0; var23 < 3; ++var23)
								{
									for (var24 = 0; var24 < 4; ++var24)
									{
										for (var25 = -1; var25 < 4; ++var25)
										{
											...
											if (var25 < 0 && !this.worldServerInstance.getBlock(var26, var27, var28).Material.Solid || var25 >= 0 && !this.worldServerInstance.isAirBlock(var26, var27, var28))
											{
												goto label274;
											}
										}
								...
								for (var20 = var12; var20 < var12 + 2; ++var20)
								{
									...
									for (var23 = 0; var23 < 4; ++var23)
									{
										for (var24 = -1; var24 < 4; ++var24)
										{
											...
											if (var24 < 0 && !this.worldServerInstance.getBlock(var25, var26, var27).Material.Solid || var24 >= 0 && !this.worldServerInstance.isAirBlock(var25, var26, var27))
											{
												goto label222;
											}
										}
			...
			if (var3 < 0.0D)
			{
				...
				if (var9 > this.worldServerInstance.ActualHeight - 10)
				{
					var9 = this.worldServerInstance.ActualHeight - 10;
				}
...
///    
///     <summary> * called periodically to remove out-of-date portal locations from the cache list. Argument par1 is a
///     * WorldServer.getTotalWorldTime() value. </summary>
///     
		public virtual void removeStalePortalLocations(long p_85189_1_)
		{
			if (p_85189_1_ % 100L == 0L)
			{
				IEnumerator var3 = this.destinationCoordinateKeys.GetEnumerator();
				long var4 = p_85189_1_ - 600L;

				while (var3.MoveNext())
				{
					long? var6 = (long?)var3.Current;
					Teleporter.PortalPosition var7 = (Teleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey((long)var6);

					if (var7 == null || var7.lastUpdateTime < var4)
					{
						var3.remove();
						this.destinationCoordinateCache.remove((long)var6);
					}
				}
			}
		}
