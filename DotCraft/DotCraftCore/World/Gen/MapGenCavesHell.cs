...
namespace DotCraftCore.World.Gen
{
	...
	{
		private const string __OBFID = "CL_00000395";

		protected internal virtual void func_151544_a(long p_151544_1_, int p_151544_3_, int p_151544_4_, Block[] p_151544_5_, double p_151544_6_, double p_151544_8_, double p_151544_10_)
		{
		...
		protected internal virtual void func_151543_a(long p_151543_1_, int p_151543_3_, int p_151543_4_, Block[] p_151543_5_, double p_151543_6_, double p_151543_8_, double p_151543_10_, float p_151543_12_, float p_151543_13_, float p_151543_14_, int p_151543_15_, int p_151543_16_, double p_151543_17_)
		{
			...
			if (p_151543_16_ <= 0)
			{
				...
				p_151543_16_ = var26 - var25.Next(var26 / 4);
			}
			...
			int var27 = var25.Next(p_151543_16_ / 2) + p_151543_16_ / 4;

			for (bool var28 = var25.Next(6) == 0; p_151543_15_ < p_151543_16_; ++p_151543_15_)
			{
		...
		protected internal override void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_)
		{
			int var7 = this.rand.Next(this.rand.Next(this.rand.Next(10) + 1) + 1);
			...
			{
				double var9 = (double)(p_151538_2_ * 16 + this.rand.Next(16));
				double var11 = (double)this.rand.Next(128);
				double var13 = (double)(p_151538_3_ * 16 + this.rand.Next(16));
				int var15 = 1;

				if (this.rand.Next(4) == 0)
				{
					this.func_151544_a(this.rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var9, var11, var13);
					var15 += this.rand.Next(4);
				}
