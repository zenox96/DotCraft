...
namespace DotCraftCore.World.Gen
{
	...
	public class NoiseGeneratorImproved : NoiseGenerator
	{
		private int[] permutations;
		public double xCoord;
		public double yCoord;
		public double zCoord;
		private static readonly double[] field_152381_e = new double[] {1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D, 0.0D, 0.0D, 0.0D, 0.0D, 1.0D, 0.0D, -1.0D, 0.0D};
		private static readonly double[] field_152382_f = new double[] {1.0D, 1.0D, -1.0D, -1.0D, 0.0D, 0.0D, 0.0D, 0.0D, 1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D};
		private static readonly double[] field_152383_g = new double[] {0.0D, 0.0D, 0.0D, 0.0D, 1.0D, 1.0D, -1.0D, -1.0D, 1.0D, 1.0D, -1.0D, -1.0D, 0.0D, 1.0D, 0.0D, -1.0D};
		private static readonly double[] field_152384_h = new double[] {1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D, 1.0D, -1.0D, 0.0D, 0.0D, 0.0D, 0.0D, 1.0D, 0.0D, -1.0D, 0.0D};
		private static readonly double[] field_152385_i = new double[] {0.0D, 0.0D, 0.0D, 0.0D, 1.0D, 1.0D, -1.0D, -1.0D, 1.0D, 1.0D, -1.0D, -1.0D, 0.0D, 1.0D, 0.0D, -1.0D};
		private const string __OBFID = "CL_00000534";

		public NoiseGeneratorImproved() : this(new Random())
		{
		}
		...
		public NoiseGeneratorImproved(Random p_i45469_1_)
		{
			...
			{
				int var3 = p_i45469_1_.Next(256 - var2) + var2;
		...
		public double func_76309_a(int p_76309_1_, double p_76309_2_, double p_76309_4_)
		{
			int var6 = p_76309_1_ & 15;
			return field_152384_h[var6] * p_76309_2_ + field_152385_i[var6] * p_76309_4_;
		}

		public double grad(int p_76310_1_, double p_76310_2_, double p_76310_4_, double p_76310_6_)
		{
...
///    
///     <summary> * pars: noiseArray , xOffset , yOffset , zOffset , xSize , ySize , zSize , xScale, yScale , zScale , noiseScale.
///     * noiseArray should be xSize*ySize*zSize in size </summary>
///     
		public virtual void populateNoiseArray(double[] p_76308_1_, double p_76308_2_, double p_76308_4_, double p_76308_6_, int p_76308_8_, int p_76308_9_, int p_76308_10_, double p_76308_11_, double p_76308_13_, double p_76308_15_, double p_76308_17_)
		{
			int var19;
			int var22;
			double var31;
