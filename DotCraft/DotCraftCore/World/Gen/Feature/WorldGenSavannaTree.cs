...
namespace DotCraftCore.nWorld.nGen.nFeature
{
	...
	public class WorldGenSavannaTree : WorldGenAbstractTree
	{
		...
		{
			int var6 = p_76484_2_.Next(3) + p_76484_2_.Next(3) + 5;
			bool var7 = true;
			...
			if (p_76484_4_ >= 1 && p_76484_4_ + var6 + 1 <= 256)
			{
				...
				else
				{
					...
					if ((var21 == Blocks.grass || var21 == Blocks.dirt) && p_76484_4_ < 256 - var6 - 1)
					{
						...
						int var22 = p_76484_2_.Next(4);
						var10 = var6 - p_76484_2_.Next(4) - 1;
						var11 = 3 - p_76484_2_.Next(3);
						...
						for (var15 = 0; var15 < var6; ++var15)
						{
							...
							if (var17.Material == Material.air || var17.Material == Material.leaves)
							{
						...
						var23 = p_76484_3_;
						var13 = p_76484_5_;
						var15 = p_76484_2_.Next(4);

						if (var15 != var22)
						{
							var16 = var10 - p_76484_2_.Next(2) - 1;
							int var24 = 1 + p_76484_2_.Next(3);
							var14 = 0;
							int var18;
							int var19;
							...
							for (var18 = var16; var18 < var6 && var24 > 0; --var24)
							{
								if (var18 >= 1)
								{
									...
									if (var20.Material == Material.air || var20.Material == Material.leaves)
									{
		...
		private void func_150525_a(World p_150525_1_, int p_150525_2_, int p_150525_3_, int p_150525_4_)
		{
			...
			if (var5.Material == Material.air || var5.Material == Material.leaves)
			{
