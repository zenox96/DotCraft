...
namespace DotCraftCore.World.Gen.Feature
{
	...
	public class WorldGenTaiga1 : WorldGenAbstractTree
	{
		private const string __OBFID = "CL_00000427";

		public WorldGenTaiga1() : base(false)
		{
		}

		public virtual bool generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
		{
			int var6 = p_76484_2_.Next(5) + 7;
			int var7 = var6 - p_76484_2_.Next(2) - 3;
			int var8 = var6 - var7;
			int var9 = 1 + p_76484_2_.Next(var8 + 1);
			bool var10 = true;
