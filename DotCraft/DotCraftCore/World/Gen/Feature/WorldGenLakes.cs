	...
	public class WorldGenLakes : WorldGenerator
	{
		...
		public override bool generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
		{
			...
			else
			{
				...
				for (var8 = 0; var8 < 16; ++var8)
				{
					for (var32 = 0; var32 < 16; ++var32)
					{
						for (var10 = 0; var10 < 8; ++var10)
						{
							...
							if (var34)
							{
								Material var12 = p_76484_1_.getBlock(p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32).Material;

								if (var10 >= 4 && var12.Liquid)
								{
									return false;
								}

								if (var10 < 4 && !var12.Solid && p_76484_1_.getBlock(p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32) != this.field_150556_a)
								{
									return false;
								}
							}
				...
				if (this.field_150556_a.Material == Material.lava)
				{
					for (var8 = 0; var8 < 16; ++var8)
					{
						for (var32 = 0; var32 < 16; ++var32)
						{
							for (var10 = 0; var10 < 8; ++var10)
							{
								...
								if (var34 && (var10 < 4 || p_76484_2_.Next(2) != 0) && p_76484_1_.getBlock(p_76484_3_ + var8, p_76484_4_ + var10, p_76484_5_ + var32).Material.Solid)
								{
				...
				if (this.field_150556_a.Material == Material.water)
				{
					for (var8 = 0; var8 < 16; ++var8)
					{
						for (var32 = 0; var32 < 16; ++var32)
