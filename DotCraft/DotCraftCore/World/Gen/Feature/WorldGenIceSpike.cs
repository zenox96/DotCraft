...
namespace DotCraftCore.World.Gen.Feature
{
	...
	public class WorldGenIceSpike : WorldGenerator
	{
		private const string __OBFID = "CL_00000417";
		...
		public override bool generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
		{
			...
			{
				p_76484_4_ += p_76484_2_.Next(4);
				int var6 = p_76484_2_.Next(4) + 7;
				int var7 = var6 / 4 + p_76484_2_.Next(2);

				if (var7 > 1 && p_76484_2_.Next(60) == 0)
				{
					p_76484_4_ += 10 + p_76484_2_.Next(30);
				}
					...
					for (var11 = -var10; var11 <= var10; ++var11)
					{
						...
						for (int var13 = -var10; var13 <= var10; ++var13)
						{
							...
							if ((var11 == 0 && var13 == 0 || var12 * var12 + var14 * var14 <= var9 * var9) && (var11 != -var10 && var11 != var10 && var13 != -var10 && var13 != var10 || p_76484_2_.nextFloat() <= 0.75F))
							{
								...
								if (var15.Material == Material.air || var15 == Blocks.dirt || var15 == Blocks.snow || var15 == Blocks.ice)
								{
					...
					while (var10 <= var8)
					{
						...
						while (true)
						{
							if (var11 > 50)
							{
								...
								if (var18.Material == Material.air || var18 == Blocks.dirt || var18 == Blocks.snow || var18 == Blocks.ice || var18 == Blocks.packed_ice)
								{
