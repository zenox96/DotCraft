...
namespace DotCraftCore.World.Gen.Feature
{
	...
	public class WorldGenCanopyTree : WorldGenAbstractTree
	{
		...
		{
			int var6 = p_76484_2_.Next(3) + p_76484_2_.Next(2) + 6;
			bool var7 = true;
			...
			if (p_76484_4_ >= 1 && p_76484_4_ + var6 + 1 <= 256)
			{
				...
				else
				{
					...
					if ((var20 == Blocks.grass || var20 == Blocks.dirt) && p_76484_4_ < 256 - var6 - 1)
					{
						...
						int var21 = p_76484_2_.Next(4);
						var10 = var6 - p_76484_2_.Next(4);
						var11 = 2 - p_76484_2_.Next(3);
						...
						for (var15 = -1; var15 <= 2; ++var15)
						{
							...
							{
								if ((var15 < 0 || var15 > 1 || var16 < 0 || var16 > 1) && p_76484_2_.Next(3) <= 0)
								{
									int var25 = p_76484_2_.Next(3) + 2;
									int var18;
