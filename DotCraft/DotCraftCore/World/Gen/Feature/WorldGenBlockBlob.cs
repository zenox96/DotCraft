...
namespace DotCraftCore.World.Gen.Feature
{
	...
	public class WorldGenBlockBlob : WorldGenerator
	{
		...
		public override bool generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
		{
			while (true)
			{
				...
				{
					int var8 = var18 + p_76484_2_.Next(2);
					int var9 = var18 + p_76484_2_.Next(2);
					int var10 = var18 + p_76484_2_.Next(2);
					...
					p_76484_3_ += -(var18 + 1) + p_76484_2_.Next(2 + var18 * 2);
					p_76484_5_ += -(var18 + 1) + p_76484_2_.Next(2 + var18 * 2);
					p_76484_4_ += 0 - p_76484_2_.Next(2);
				}
