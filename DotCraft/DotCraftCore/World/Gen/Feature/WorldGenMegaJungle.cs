	...
	public class WorldGenMegaJungle : WorldGenHugeTrees
	{
		...
		public override bool generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
		{
			...
			else
			{
				...
				for (int var7 = p_76484_4_ + var6 - 2 - p_76484_2_.Next(4); var7 > p_76484_4_ + var6 / 2; var7 -= 2 + p_76484_2_.Next(4))
				{
				...
				for (int var15 = 0; var15 < var6; ++var15)
				{
					...
					if (var16.Material == Material.air || var16.Material == Material.leaves)
					{
						...
						if (var15 > 0)
						{
							if (p_76484_2_.Next(3) > 0 && p_76484_1_.isAirBlock(p_76484_3_ - 1, p_76484_4_ + var15, p_76484_5_))
							{
								this.func_150516_a(p_76484_1_, p_76484_3_ - 1, p_76484_4_ + var15, p_76484_5_, Blocks.vine, 8);
							}

							if (p_76484_2_.Next(3) > 0 && p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_ + var15, p_76484_5_ - 1))
							{
					...
					if (var15 < var6 - 1)
					{
						...
						if (var16.Material == Material.air || var16.Material == Material.leaves)
						{
							...
							if (var15 > 0)
							{
								if (p_76484_2_.Next(3) > 0 && p_76484_1_.isAirBlock(p_76484_3_ + 2, p_76484_4_ + var15, p_76484_5_))
								{
									this.func_150516_a(p_76484_1_, p_76484_3_ + 2, p_76484_4_ + var15, p_76484_5_, Blocks.vine, 2);
								}

								if (p_76484_2_.Next(3) > 0 && p_76484_1_.isAirBlock(p_76484_3_ + 1, p_76484_4_ + var15, p_76484_5_ - 1))
								{
						...
						if (var16.Material == Material.air || var16.Material == Material.leaves)
						{
							...
							if (var15 > 0)
							{
								if (p_76484_2_.Next(3) > 0 && p_76484_1_.isAirBlock(p_76484_3_ + 2, p_76484_4_ + var15, p_76484_5_ + 1))
								{
									this.func_150516_a(p_76484_1_, p_76484_3_ + 2, p_76484_4_ + var15, p_76484_5_ + 1, Blocks.vine, 2);
								}

								if (p_76484_2_.Next(3) > 0 && p_76484_1_.isAirBlock(p_76484_3_ + 1, p_76484_4_ + var15, p_76484_5_ + 2))
								{
						...
						if (var16.Material == Material.air || var16.Material == Material.leaves)
						{
							...
							if (var15 > 0)
							{
								...
								if (p_76484_2_.Next(3) > 0 && p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_ + var15, p_76484_5_ + 2))
								{
