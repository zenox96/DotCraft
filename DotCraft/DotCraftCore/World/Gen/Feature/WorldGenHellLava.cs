...
namespace DotCraftCore.World.Gen.Feature
{
	...
	public class WorldGenHellLava : WorldGenerator
	{
		...
		public override bool generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
		{
			...
			else if (p_76484_1_.getBlock(p_76484_3_, p_76484_4_, p_76484_5_).Material != Material.air && p_76484_1_.getBlock(p_76484_3_, p_76484_4_, p_76484_5_) != Blocks.netherrack)
			{
				return false;
			}
			else
