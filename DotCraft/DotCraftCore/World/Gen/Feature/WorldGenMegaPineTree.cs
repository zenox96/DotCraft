...
namespace DotCraftCore.World.Gen.Feature
{
	...
	public class WorldGenMegaPineTree : WorldGenHugeTrees
	{
		...
		public override bool generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
		{
			...
			else
			{
				...
				for (int var7 = 0; var7 < var6; ++var7)
				{
					...
					if (var8.Material == Material.air || var8.Material == Material.leaves)
					{
		...
		public override void func_150524_b(World p_150524_1_, Random p_150524_2_, int p_150524_3_, int p_150524_4_, int p_150524_5_)
		{
		...
		private void func_150540_a(World p_150540_1_, int p_150540_2_, int p_150540_3_, int p_150540_4_)
		{
			for (int var5 = p_150540_3_ + 2; var5 >= p_150540_3_ - 3; --var5)
			{
				...
				if (var6.Material != Material.air && var5 < p_150540_3_)
				{
					break;
				}
			}
