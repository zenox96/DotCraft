...
namespace DotCraftCore.World.Gen.Feature
{
	...
	public class WorldGenSwamp : WorldGenAbstractTree
	{
		...
		public virtual bool generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
		{
			...
			for (var6 = p_76484_2_.Next(4) + 5; p_76484_1_.getBlock(p_76484_3_, p_76484_4_ - 1, p_76484_5_).Material == Material.water; --p_76484_4_)
			{
				;
			}
				...
				else
				{
					...
					if ((var16 == Blocks.grass || var16 == Blocks.dirt) && p_76484_4_ < 256 - var6 - 1)
					{
						...
						for (var17 = p_76484_4_ - 3 + var6; var17 <= p_76484_4_ + var6; ++var17)
						{
							...
							for (var19 = p_76484_3_ - var11; var19 <= p_76484_3_ + var11; ++var19)
							{
								...
								for (int var14 = p_76484_5_ - var11; var14 <= p_76484_5_ + var11; ++var14)
								{
									...
									if ((Math.Abs(var13) != var11 || Math.Abs(var15) != var11 || p_76484_2_.Next(2) != 0 && var10 != 0) && !p_76484_1_.getBlock(var19, var17, var14).func_149730_j())
									{
						...
						for (var17 = 0; var17 < var6; ++var17)
						{
							...
							if (var18.Material == Material.air || var18.Material == Material.leaves || var18 == Blocks.flowing_water || var18 == Blocks.water)
							{
						...
						for (var17 = p_76484_4_ - 3 + var6; var17 <= p_76484_4_ + var6; ++var17)
						{
							...
							for (var19 = p_76484_3_ - var11; var19 <= p_76484_3_ + var11; ++var19)
							{
								...
								{
									if (p_76484_1_.getBlock(var19, var17, var13).Material == Material.leaves)
									{
										if (p_76484_2_.Next(4) == 0 && p_76484_1_.getBlock(var19 - 1, var17, var13).Material == Material.air)
										{
										...
										if (p_76484_2_.Next(4) == 0 && p_76484_1_.getBlock(var19, var17, var13 - 1).Material == Material.air)
										{
...
///    
///     <summary> * Generates vines at the given position until it hits a block. </summary>
///     
		private void generateVines(World p_76536_1_, int p_76536_2_, int p_76536_3_, int p_76536_4_, int p_76536_5_)
		{
			...
			while (true)
			{
				...
				if (p_76536_1_.getBlock(p_76536_2_, p_76536_3_, p_76536_4_).Material != Material.air || var6 <= 0)
				{
					return;
				}
