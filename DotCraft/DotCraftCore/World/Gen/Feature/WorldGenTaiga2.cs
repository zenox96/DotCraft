...
namespace DotCraftCore.World.Gen.Feature
{
	...
	public class WorldGenTaiga2 : WorldGenAbstractTree
	{
		...
		{
			int var6 = p_76484_2_.Next(4) + 6;
			int var7 = 1 + p_76484_2_.Next(2);
			int var8 = var6 - var7;
			int var9 = 2 + p_76484_2_.Next(2);
			bool var10 = true;
					...
					for (var13 = p_76484_3_ - var22; var13 <= p_76484_3_ + var22 && var10; ++var13)
					{
						for (int var14 = p_76484_5_ - var22; var14 <= p_76484_5_ + var22 && var10; ++var14)
						{
							if (var11 >= 0 && var11 < 256)
							{
								...
								if (var15.Material != Material.air && var15.Material != Material.leaves)
								{
									var10 = false;
								}
							}
