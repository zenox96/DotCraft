...
namespace DotCraftCore.World.Gen
{
	...
	public class MapGenCaves : MapGenBase
	{
		...
		protected internal virtual void func_151541_a(long p_151541_1_, int p_151541_3_, int p_151541_4_, Block[] p_151541_5_, double p_151541_6_, double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_, double p_151541_17_)
		{
			...
			if (p_151541_16_ <= 0)
			{
				...
				p_151541_16_ = var26 - var25.Next(var26 / 4);
			}
			...
			int var27 = var25.Next(p_151541_16_ / 2) + p_151541_16_ / 4;

			for (bool var28 = var25.Next(6) == 0; p_151541_15_ < p_151541_16_; ++p_151541_15_)
			{
		...
		{
			int var7 = this.rand.Next(this.rand.Next(this.rand.Next(15) + 1) + 1);

			if (this.rand.Next(7) != 0)
			{
				var7 = 0;
			}
			...
			for (int var8 = 0; var8 < var7; ++var8)
			{
				...
				double var11 = (double)this.rand.Next(this.rand.Next(120) + 8);
