...
namespace DotCraftCore.World.Gen
{
	...
	public class MapGenRavine : MapGenBase
	{
		...
		private const string __OBFID = "CL_00000390";

		protected internal virtual void func_151540_a(long p_151540_1_, int p_151540_3_, int p_151540_4_, Block[] p_151540_5_, double p_151540_6_, double p_151540_8_, double p_151540_10_, float p_151540_12_, float p_151540_13_, float p_151540_14_, int p_151540_15_, int p_151540_16_, double p_151540_17_)
		{
			...
			if (p_151540_16_ <= 0)
			{
				...
				p_151540_16_ = var26 - var19.Next(var26 / 4);
			}
		...
		protected internal override void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_)
		{
			...
			{
				double var7 = (double)(p_151538_2_ * 16 + this.rand.Next(16));
				double var9 = (double)(this.rand.Next(this.rand.Next(40) + 8) + 20);
				double var11 = (double)(p_151538_3_ * 16 + this.rand.Next(16));
				sbyte var13 = 1;
