...
namespace DotCraftCore.World.Gen.Structure
{
	...
	{
		private const string __OBFID = "CL_00000473";

		public static void func_143045_a()
		{
			MapGenStructureIO.func_143031_a(typeof(ComponentScatteredFeaturePieces.DesertPyramid), "TeDP");
			MapGenStructureIO.func_143031_a(typeof(ComponentScatteredFeaturePieces.JunglePyramid), "TeJP");
			MapGenStructureIO.func_143031_a(typeof(ComponentScatteredFeaturePieces.SwampHut), "TeSH");
		}

		public class DesertPyramid : ComponentScatteredFeaturePieces.Feature
		{
			private bool[] field_74940_h = new bool[4];
			...
			private const string __OBFID = "CL_00000476";

			public DesertPyramid()
			{
			}

			public DesertPyramid(Random p_i2062_1_, int p_i2062_2_, int p_i2062_3_) : base(p_i2062_1_, p_i2062_2_, 64, p_i2062_3_, 21, 15, 21)
			{
			}
			...
			public virtual bool addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
			{
				...
				for (var10 = 0; var10 < 4; ++var10)
				{
					if (!this.field_74940_h[var10])
					{
						...
						this.field_74940_h[var10] = this.generateStructureChestContents(p_74875_1_, p_74875_3_, p_74875_2_, 10 + var11, -11, 10 + var12, WeightedRandomChestContent.func_92080_a(itemsToGenerateInTemple, new WeightedRandomChestContent[] {Items.enchanted_book.func_92114_b(p_74875_2_)}), 2 + p_74875_2_.Next(5));
					}
				}
		...
		internal abstract class Feature : StructureComponent
		{
			protected internal int scatteredFeatureSizeX;
			protected internal int scatteredFeatureSizeY;
			protected internal int scatteredFeatureSizeZ;
			protected internal int field_74936_d = -1;
			private const string __OBFID = "CL_00000479";

			public Feature()
			{
			}

			protected internal Feature(Random p_i2065_1_, int p_i2065_2_, int p_i2065_3_, int p_i2065_4_, int p_i2065_5_, int p_i2065_6_, int p_i2065_7_) : base(0)
			{
				this.scatteredFeatureSizeX = p_i2065_5_;
				this.scatteredFeatureSizeY = p_i2065_6_;
				this.scatteredFeatureSizeZ = p_i2065_7_;
				this.coordBaseMode = p_i2065_1_.Next(4);
			...
			protected internal virtual bool func_74935_a(World p_74935_1_, StructureBoundingBox p_74935_2_, int p_74935_3_)
			{
				...
				else
				{
					...
					for (int var6 = this.boundingBox.minZ; var6 <= this.boundingBox.maxZ; ++var6)
					{
						for (int var7 = this.boundingBox.minX; var7 <= this.boundingBox.maxX; ++var7)
						{
							...
							{
								var4 += Math.Max(p_74935_1_.getTopSolidOrLiquidBlock(var7, var6), p_74935_1_.provider.AverageGroundLevel);
								++var5;
							}
						}
					}
		...
		public class JunglePyramid : ComponentScatteredFeaturePieces.Feature
		{
			private bool field_74947_h;
			private bool field_74948_i;
			private bool field_74945_j;
			private bool field_74946_k;
			private static readonly WeightedRandomChestContent[] junglePyramidsChestContents = new WeightedRandomChestContent[] {new WeightedRandomChestContent(Items.diamond, 0, 1, 3, 3), new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 5, 10), new WeightedRandomChestContent(Items.gold_ingot, 0, 2, 7, 15), new WeightedRandomChestContent(Items.emerald, 0, 1, 3, 2), new WeightedRandomChestContent(Items.bone, 0, 4, 6, 20), new WeightedRandomChestContent(Items.rotten_flesh, 0, 3, 7, 16), new WeightedRandomChestContent(Items.saddle, 0, 1, 1, 3), new WeightedRandomChestContent(Items.iron_horse_armor, 0, 1, 1, 1), new WeightedRandomChestContent(Items.golden_horse_armor, 0, 1, 1, 1), new WeightedRandomChestContent(Items.diamond_horse_armor, 0, 1, 1, 1)};
			private static readonly WeightedRandomChestContent[] junglePyramidsDispenserContents = new WeightedRandomChestContent[] {new WeightedRandomChestContent(Items.arrow, 0, 2, 7, 30)};
			...
			private const string __OBFID = "CL_00000477";

			public JunglePyramid()
			{
			}

			public JunglePyramid(Random p_i2064_1_, int p_i2064_2_, int p_i2064_3_) : base(p_i2064_1_, p_i2064_2_, 64, p_i2064_3_, 12, 10, 15)
			{
			}
			...
			public virtual bool addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
			{
				...
				else
				{
					...
					{
						this.field_74947_h = this.generateStructureChestContents(p_74875_1_, p_74875_3_, p_74875_2_, 8, -3, 3, WeightedRandomChestContent.func_92080_a(junglePyramidsChestContents, new WeightedRandomChestContent[] {Items.enchanted_book.func_92114_b(p_74875_2_)}), 2 + p_74875_2_.Next(5));
					}
					...
					{
						this.field_74948_i = this.generateStructureChestContents(p_74875_1_, p_74875_3_, p_74875_2_, 9, -3, 10, WeightedRandomChestContent.func_92080_a(junglePyramidsChestContents, new WeightedRandomChestContent[] {Items.enchanted_book.func_92114_b(p_74875_2_)}), 2 + p_74875_2_.Next(5));
					}
			...
			{
				private const string __OBFID = "CL_00000478";
				...
				internal Stones(object p_i2063_1_) : this()
				{
				}
			}
		}

		public class SwampHut : ComponentScatteredFeaturePieces.Feature
		{
			private bool hasWitch;
			private const string __OBFID = "CL_00000480";

			public SwampHut()
			{
			}

			public SwampHut(Random p_i2066_1_, int p_i2066_2_, int p_i2066_3_) : base(p_i2066_1_, p_i2066_2_, 64, p_i2066_3_, 7, 5, 9)
			{
			}
