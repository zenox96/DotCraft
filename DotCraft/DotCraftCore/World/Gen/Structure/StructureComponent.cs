...
namespace DotCraftCore.World.Gen.Structure
{
	...
	/// <summary> switches the Coordinate System base off the Bounding Box  </summary>
	...
	/// <summary> The type ID of this component.  </summary>
		...
		protected internal StructureComponent(int p_i2091_1_)
		{
			this.componentType = p_i2091_1_;
			this.coordBaseMode = -1;
		}

		public virtual NBTTagCompound func_143010_b()
		{
		...
		protected internal abstract void func_143012_a(NBTTagCompound p_143012_1_);

		public virtual void func_143009_a(World p_143009_1_, NBTTagCompound p_143009_2_)
		{
		...
		protected internal abstract void func_143011_b(NBTTagCompound p_143011_1_);

///    
///     <summary> * Initiates construction of the Structure Component picked, at the current Location of StructGen </summary>
///     
...
///    
///     <summary> * second Part of Structure generating, this for example places Spiderwebs, Mob Spawners, it closes Mineshafts at
///     * the end, it adds Fences... </summary>
///     
		public abstract bool addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_);
...
///    
///     <summary> * Returns the component type ID of this component. </summary>
///     
...
///    
///     <summary> * Discover if bounding box can fit within the current bounding box object. </summary>
///     
		public static StructureComponent findIntersecting(IList p_74883_0_, StructureBoundingBox p_74883_1_)
		{
			IEnumerator var2 = p_74883_0_.GetEnumerator();
			...
			do
			{
				...
				var3 = (StructureComponent)var2.Current;
			}
			while (var3.BoundingBox == null || !var3.BoundingBox.intersectsWith(p_74883_1_));
...
///    
///     <summary> * checks the entire StructureBoundingBox for Liquids </summary>
///     
		protected internal virtual bool isLiquidInStructureBoundingBox(World p_74860_1_, StructureBoundingBox p_74860_2_)
		{
			...
			for (var9 = var3; var9 <= var6; ++var9)
			{
				...
				{
					if (p_74860_1_.getBlock(var9, var4, var10).Material.Liquid)
					{
						return true;
					}

					if (p_74860_1_.getBlock(var9, var7, var10).Material.Liquid)
					{
						return true;
					}
				}
			...
			for (var9 = var3; var9 <= var6; ++var9)
			{
				...
				{
					if (p_74860_1_.getBlock(var9, var10, var5).Material.Liquid)
					{
						return true;
					}

					if (p_74860_1_.getBlock(var9, var10, var8).Material.Liquid)
					{
						return true;
					}
				}
			...
			for (var9 = var5; var9 <= var8; ++var9)
			{
				for (var10 = var4; var10 <= var7; ++var10)
				{
					if (p_74860_1_.getBlock(var3, var10, var9).Material.Liquid)
					{
						return true;
					}

					if (p_74860_1_.getBlock(var6, var10, var9).Material.Liquid)
					{
						return true;
					}
				}
		...
		protected internal virtual int getXWithOffset(int p_74865_1_, int p_74865_2_)
		{
		...
		protected internal virtual int getYWithOffset(int p_74862_1_)
		{
			return this.coordBaseMode == -1 ? p_74862_1_ : p_74862_1_ + this.boundingBox.minY;
		}

		protected internal virtual int getZWithOffset(int p_74873_1_, int p_74873_2_)
		{
			switch (this.coordBaseMode)
			{
				case 0:
		...
		protected internal virtual int func_151555_a(Block p_151555_1_, int p_151555_2_)
		{
			...
			else if (p_151555_1_ != Blocks.wooden_door && p_151555_1_ != Blocks.iron_door)
			{
				if (p_151555_1_ != Blocks.stone_stairs && p_151555_1_ != Blocks.oak_stairs && p_151555_1_ != Blocks.nether_brick_stairs && p_151555_1_ != Blocks.stone_brick_stairs && p_151555_1_ != Blocks.sandstone_stairs)
				{
					...
					else if (p_151555_1_ != Blocks.tripwire_hook && !(p_151555_1_ is BlockDirectional))
					{
		...
		protected internal virtual void func_151550_a(World p_151550_1_, Block p_151550_2_, int p_151550_3_, int p_151550_4_, int p_151550_5_, int p_151550_6_, StructureBoundingBox p_151550_7_)
		{
		...
		protected internal virtual Block func_151548_a(World p_151548_1_, int p_151548_2_, int p_151548_3_, int p_151548_4_, StructureBoundingBox p_151548_5_)
		{
...
///    
///     <summary> * arguments: (World worldObj, StructureBoundingBox structBB, int minX, int minY, int minZ, int maxX, int maxY, int
///     * maxZ) </summary>
///     
		protected internal virtual void fillWithAir(World p_74878_1_, StructureBoundingBox p_74878_2_, int p_74878_3_, int p_74878_4_, int p_74878_5_, int p_74878_6_, int p_74878_7_, int p_74878_8_)
		{
		...
		protected internal virtual void func_151549_a(World p_151549_1_, StructureBoundingBox p_151549_2_, int p_151549_3_, int p_151549_4_, int p_151549_5_, int p_151549_6_, int p_151549_7_, int p_151549_8_, Block p_151549_9_, Block p_151549_10_, bool p_151549_11_)
		{
			for (int var12 = p_151549_4_; var12 <= p_151549_7_; ++var12)
			{
				for (int var13 = p_151549_3_; var13 <= p_151549_6_; ++var13)
				{
					...
					{
						if (!p_151549_11_ || this.func_151548_a(p_151549_1_, var13, var12, var14, p_151549_2_).Material != Material.air)
						{
		...
		protected internal virtual void func_151556_a(World p_151556_1_, StructureBoundingBox p_151556_2_, int p_151556_3_, int p_151556_4_, int p_151556_5_, int p_151556_6_, int p_151556_7_, int p_151556_8_, Block p_151556_9_, int p_151556_10_, Block p_151556_11_, int p_151556_12_, bool p_151556_13_)
		{
			for (int var14 = p_151556_4_; var14 <= p_151556_7_; ++var14)
			{
				for (int var15 = p_151556_3_; var15 <= p_151556_6_; ++var15)
				{
					...
					{
						if (!p_151556_13_ || this.func_151548_a(p_151556_1_, var15, var14, var16, p_151556_2_).Material != Material.air)
						{
...
///    
///     <summary> * arguments: World worldObj, StructureBoundingBox structBB, int minX, int minY, int minZ, int maxX, int maxY, int
///     * maxZ, boolean alwaysreplace, Random rand, StructurePieceBlockSelector blockselector </summary>
///     
		protected internal virtual void fillWithRandomizedBlocks(World p_74882_1_, StructureBoundingBox p_74882_2_, int p_74882_3_, int p_74882_4_, int p_74882_5_, int p_74882_6_, int p_74882_7_, int p_74882_8_, bool p_74882_9_, Random p_74882_10_, StructureComponent.BlockSelector p_74882_11_)
		{
			for (int var12 = p_74882_4_; var12 <= p_74882_7_; ++var12)
			{
				for (int var13 = p_74882_3_; var13 <= p_74882_6_; ++var13)
				{
					...
					{
						if (!p_74882_9_ || this.func_151548_a(p_74882_1_, var13, var12, var14, p_74882_2_).Material != Material.air)
						{
							...
							this.func_151550_a(p_74882_1_, p_74882_11_.func_151561_a(), p_74882_11_.SelectedBlockMetaData, var13, var12, var14, p_74882_2_);
						}
					}
				}
			}
		...
		protected internal virtual void func_151551_a(World p_151551_1_, StructureBoundingBox p_151551_2_, Random p_151551_3_, float p_151551_4_, int p_151551_5_, int p_151551_6_, int p_151551_7_, int p_151551_8_, int p_151551_9_, int p_151551_10_, Block p_151551_11_, Block p_151551_12_, bool p_151551_13_)
		{
			for (int var14 = p_151551_6_; var14 <= p_151551_9_; ++var14)
			{
				for (int var15 = p_151551_5_; var15 <= p_151551_8_; ++var15)
				{
					...
					{
						if (p_151551_3_.nextFloat() <= p_151551_4_ && (!p_151551_13_ || this.func_151548_a(p_151551_1_, var15, var14, var16, p_151551_2_).Material != Material.air))
						{
		...
		protected internal virtual void func_151552_a(World p_151552_1_, StructureBoundingBox p_151552_2_, Random p_151552_3_, float p_151552_4_, int p_151552_5_, int p_151552_6_, int p_151552_7_, Block p_151552_8_, int p_151552_9_)
		{
		...
		protected internal virtual void func_151547_a(World p_151547_1_, StructureBoundingBox p_151547_2_, int p_151547_3_, int p_151547_4_, int p_151547_5_, int p_151547_6_, int p_151547_7_, int p_151547_8_, Block p_151547_9_, bool p_151547_10_)
		{
			...
			for (int var16 = p_151547_4_; var16 <= p_151547_7_; ++var16)
			{
				...
				for (int var18 = p_151547_3_; var18 <= p_151547_6_; ++var18)
				{
					...
					for (int var20 = p_151547_5_; var20 <= p_151547_8_; ++var20)
					{
						...
						if (!p_151547_10_ || this.func_151548_a(p_151547_1_, var18, var16, var20, p_151547_2_).Material != Material.air)
						{
...
///    
///     <summary> * Deletes all continuous blocks from selected position upwards. Stops at hitting air. </summary>
///     
		protected internal virtual void clearCurrentPositionBlocksUpwards(World p_74871_1_, int p_74871_2_, int p_74871_3_, int p_74871_4_, StructureBoundingBox p_74871_5_)
		{
		...
		protected internal virtual void func_151554_b(World p_151554_1_, Block p_151554_2_, int p_151554_3_, int p_151554_4_, int p_151554_5_, int p_151554_6_, StructureBoundingBox p_151554_7_)
		{
			...
			{
				while ((p_151554_1_.isAirBlock(var8, var9, var10) || p_151554_1_.getBlock(var8, var9, var10).Material.Liquid) && var9 > 1)
				{
...
///    
///     <summary> * Used to generate chests with items in it. ex: Temple Chests, Village Blacksmith Chests, Mineshaft Chests. </summary>
///     
		protected internal virtual bool generateStructureChestContents(World p_74879_1_, StructureBoundingBox p_74879_2_, Random p_74879_3_, int p_74879_4_, int p_74879_5_, int p_74879_6_, WeightedRandomChestContent[] p_74879_7_, int p_74879_8_)
		{
...
///    
///     <summary> * Used to generate dispenser contents for structures. ex: Jungle Temples. </summary>
///     
		protected internal virtual bool generateStructureDispenserContents(World p_74869_1_, StructureBoundingBox p_74869_2_, Random p_74869_3_, int p_74869_4_, int p_74869_5_, int p_74869_6_, int p_74869_7_, WeightedRandomChestContent[] p_74869_8_, int p_74869_9_)
		{
		...
		protected internal virtual void placeDoorAtCurrentPosition(World p_74881_1_, StructureBoundingBox p_74881_2_, Random p_74881_3_, int p_74881_4_, int p_74881_5_, int p_74881_6_, int p_74881_7_)
		{
		...
		public abstract class BlockSelector
		{
			...
			public abstract void selectBlocks(Random p_75062_1_, int p_75062_2_, int p_75062_3_, int p_75062_4_, bool p_75062_5_);

			public virtual Block func_151561_a()
			{
