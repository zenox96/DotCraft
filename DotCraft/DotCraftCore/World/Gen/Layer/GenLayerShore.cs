namespace DotCraftCore.World.Gen.Layer
{
	...
	{
		private const string __OBFID = "CL_00000568";

		public GenLayerShore(long p_i2130_1_, GenLayer p_i2130_3_) : base(p_i2130_1_)
		{
		...
		public override int[] getInts(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_)
		{
			...
			for (int var7 = 0; var7 < p_75904_4_; ++var7)
			{
				for (int var8 = 0; var8 < p_75904_3_; ++var8)
				{
					...
					else if (var10 != null && var10.func_150562_l() == typeof(BiomeGenJungle))
					{
						var11 = var5[var8 + 1 + (var7 + 1 - 1) * (p_75904_3_ + 2)];
						var12 = var5[var8 + 1 + 1 + (var7 + 1) * (p_75904_3_ + 2)];
						var13 = var5[var8 + 1 - 1 + (var7 + 1) * (p_75904_3_ + 2)];
