			...
			for (int var7 = 0; var7 < p_75904_4_; ++var7)
			{
				for (int var8 = 0; var8 < p_75904_3_; ++var8)
				{
					...
					else if (var9 == 1)
					{
						...
						{
							var6[var8 + var7 * p_75904_3_] = this.field_151623_c[this.Next(this.field_151623_c.Length)].biomeID;
						}
					}
					else if (var9 == 2)
					{
						...
						{
							var6[var8 + var7 * p_75904_3_] = this.field_151621_d[this.Next(this.field_151621_d.Length)].biomeID;
						}
					}
					else if (var9 == 3)
					{
						...
						{
							var6[var8 + var7 * p_75904_3_] = this.field_151622_e[this.Next(this.field_151622_e.Length)].biomeID;
						}
					}
					else if (var9 == 4)
					{
						var6[var8 + var7 * p_75904_3_] = this.field_151620_f[this.Next(this.field_151620_f.Length)].biomeID;
					}
					else
					{
