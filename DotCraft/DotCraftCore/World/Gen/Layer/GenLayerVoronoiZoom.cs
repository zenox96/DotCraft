		...
		public override int[] getInts(int p_75904_1_, int p_75904_2_, int p_75904_3_, int p_75904_4_)
		{
			...
			for (int var13 = 0; var13 < var8 - 1; ++var13)
			{
				...
				for (int var16 = var9[var14 + 0 + (var13 + 1) * var7]; var14 < var7 - 1; ++var14)
				{
					...
					double var19 = ((double)this.Next(1024) / 1024.0D - 0.5D) * 3.6D;
					double var21 = ((double)this.Next(1024) / 1024.0D - 0.5D) * 3.6D;
					this.initChunkSeed((long)(var14 + var5 + 1 << 2), (long)(var13 + var6 << 2));
					double var23 = ((double)this.Next(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
					double var25 = ((double)this.Next(1024) / 1024.0D - 0.5D) * 3.6D;
					this.initChunkSeed((long)(var14 + var5 << 2), (long)(var13 + var6 + 1 << 2));
					double var27 = ((double)this.Next(1024) / 1024.0D - 0.5D) * 3.6D;
					double var29 = ((double)this.Next(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
					this.initChunkSeed((long)(var14 + var5 + 1 << 2), (long)(var13 + var6 + 1 << 2));
					double var31 = ((double)this.Next(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
					double var33 = ((double)this.Next(1024) / 1024.0D - 0.5D) * 3.6D + 4.0D;
			...
			{
				Array.Copy(var12, (var14 + (p_75904_2_ & 3)) * var10 + (p_75904_1_ & 3), var48, var14 * p_75904_3_, p_75904_3_);
			}
