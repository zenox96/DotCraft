...
namespace DotCraftCore.nWorld.nGen.nLayer
{
	...
	{
	/// <summary> seed from World#getWorldSeed that is used in the LCG prng  </summary>
		private long worldGenSeed;

	/// <summary> parent GenLayer that was provided via the constructor  </summary>
		protected internal GenLayer parent;

///    
///     <summary> * final part of the LCG prng that uses the chunk X, Z coords along with the other two seeds to generate
...
///    
///     <summary> * Initialize layer's local worldGenSeed based on its own baseSeed and the world's global seed (passed in as an
///     * argument). </summary>
///     
		public virtual void initWorldGenSeed(long p_75905_1_)
		{
...
///    
///     <summary> * Initialize layer's current chunkSeed based on the local worldGenSeed and the (x,z) chunk coordinates. </summary>
///     
		public virtual void initChunkSeed(long p_75903_1_, long p_75903_3_)
		{
...
///    
///     <summary> * returns a LCG pseudo random number from [0, x). Args: int x </summary>
///     
		protected internal virtual int nextInt(int p_75902_1_)
		{
...
//ORIGINAL LINE: protected static boolean func_151616_a(final int p_151616_0_, final int p_151616_1_)
		protected internal static bool func_151616_a(int p_151616_0_, int p_151616_1_)
		{
		...
		protected internal static bool func_151618_b(int p_151618_0_)
		{
		...
		protected internal virtual int func_151619_a(params int[] p_151619_1_)
		{
			return p_151619_1_[this.Next(p_151619_1_.length)];
		}

		protected internal virtual int func_151617_b(int p_151617_1_, int p_151617_2_, int p_151617_3_, int p_151617_4_)
		{
