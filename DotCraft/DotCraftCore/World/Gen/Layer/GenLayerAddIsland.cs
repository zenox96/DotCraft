namespace DotCraftCore.World.Gen.Layer
{
	...
	{
		private const string __OBFID = "CL_00000551";

		public GenLayerAddIsland(long p_i2119_1_, GenLayer p_i2119_3_) : base(p_i2119_1_)
		{
			...
			for (int var11 = 0; var11 < p_75904_4_; ++var11)
			{
				for (int var12 = 0; var12 < p_75904_3_; ++var12)
				{
					...
					if (var17 == 0 && (var13 != 0 || var14 != 0 || var15 != 0 || var16 != 0))
					{
						...
						if (var13 != 0 && this.Next(var18++) == 0)
						{
							var19 = var13;
						}

						if (var14 != 0 && this.Next(var18++) == 0)
						{
							var19 = var14;
						}

						if (var15 != 0 && this.Next(var18++) == 0)
						{
							var19 = var15;
						}

						if (var16 != 0 && this.Next(var18++) == 0)
						{
							var19 = var16;
						}
