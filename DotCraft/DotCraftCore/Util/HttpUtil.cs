...
namespace DotCraftCore.Util
{
	...
	/// <summary> The number of download threads that we have started so far.  </summary>
		...
		private const string __OBFID = "CL_00001485";
