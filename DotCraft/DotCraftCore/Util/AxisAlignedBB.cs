...
///     
		...
		protected internal AxisAlignedBB(double p_i2300_1_, double p_i2300_3_, double p_i2300_5_, double p_i2300_7_, double p_i2300_9_, double p_i2300_11_)
		{
...
///    
///     <summary> * Sets the bounds of the bounding box. Args: minX, minY, minZ, maxX, maxY, maxZ </summary>
///     
		public virtual AxisAlignedBB setBounds(double p_72324_1_, double p_72324_3_, double p_72324_5_, double p_72324_7_, double p_72324_9_, double p_72324_11_)
		{
...
///    
///     <summary> * Adds the coordinates to the bounding box extending it if the point lies outside the current ranges. Args: x, y, z </summary>
///     
		public virtual AxisAlignedBB addCoord(double p_72321_1_, double p_72321_3_, double p_72321_5_)
		{
...
///    
///     <summary> * Returns a bounding box expanded by the specified vector (if negative numbers are given it will shrink). Args: x,
///     * y, z </summary>
///     
		public virtual AxisAlignedBB expand(double p_72314_1_, double p_72314_3_, double p_72314_5_)
		{
		...
		public virtual AxisAlignedBB func_111270_a(AxisAlignedBB p_111270_1_)
		{
...
///    
///     <summary> * Returns a bounding box offseted by the specified vector (if negative numbers are given it will shrink). Args: x,
///     * y, z </summary>
///     
		public virtual AxisAlignedBB getOffsetBoundingBox(double p_72325_1_, double p_72325_3_, double p_72325_5_)
		{
...
///    
///     <summary> * if instance and the argument bounding boxes overlap in the Y and Z dimensions, calculate the offset between them
///     * in the X dimension.  return var2 if the bounding boxes do not overlap or if var2 is closer to 0 then the
///     * calculated offset.  Otherwise return the calculated offset. </summary>
///     
		public virtual double calculateXOffset(AxisAlignedBB p_72316_1_, double p_72316_2_)
		{
...
///    
///     <summary> * if instance and the argument bounding boxes overlap in the X and Z dimensions, calculate the offset between them
///     * in the Y dimension.  return var2 if the bounding boxes do not overlap or if var2 is closer to 0 then the
///     * calculated offset.  Otherwise return the calculated offset. </summary>
///     
		public virtual double calculateYOffset(AxisAlignedBB p_72323_1_, double p_72323_2_)
		{
...
///    
///     <summary> * if instance and the argument bounding boxes overlap in the Y and X dimensions, calculate the offset between them
///     * in the Z dimension.  return var2 if the bounding boxes do not overlap or if var2 is closer to 0 then the
///     * calculated offset.  Otherwise return the calculated offset. </summary>
///     
		public virtual double calculateZOffset(AxisAlignedBB p_72322_1_, double p_72322_2_)
		{
...
///    
///     <summary> * Returns whether the given bounding box intersects with this one. Args: axisAlignedBB </summary>
///     
		public virtual bool intersectsWith(AxisAlignedBB p_72326_1_)
		{
//JAVA TO VB & C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: return p_72326_1_.maxX > this.minX && p_72326_1_.minX < this.maxX ? (p_72326_1_.maxY > this.minY && p_72326_1_.minY < this.maxY ? p_72326_1_.maxZ > this.minZ && p_72326_1_.minZ < this.maxZ : false) : false;
...
///     
		public virtual AxisAlignedBB offset(double p_72317_1_, double p_72317_3_, double p_72317_5_)
		{
...
///    
///     <summary> * Returns if the supplied Vec3D is completely inside the bounding box </summary>
///     
		public virtual bool isVecInside(Vec3 p_72318_1_)
		{
//JAVA TO VB & C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: return p_72318_1_.xCoord > this.minX && p_72318_1_.xCoord < this.maxX ? (p_72318_1_.yCoord > this.minY && p_72318_1_.yCoord < this.maxY ? p_72318_1_.zCoord > this.minZ && p_72318_1_.zCoord < this.maxZ : false) : false;
...
///    
///     <summary> * Returns the average length of the edges of the bounding box. </summary>
///     
...
///    
///     <summary> * Returns a bounding box that is inset by the specified amounts </summary>
///     
		public virtual AxisAlignedBB contract(double p_72331_1_, double p_72331_3_, double p_72331_5_)
		{
...
///    
///     <summary> * Returns a copy of the bounding box. </summary>
///     
		...
		public virtual MovingObjectPosition calculateIntercept(Vec3 p_72327_1_, Vec3 p_72327_2_)
		{
...
///    
///     <summary> * Checks if the specified vector is within the YZ dimensions of the bounding box. Args: Vec3D </summary>
///     
		private bool isVecInYZ(Vec3 p_72333_1_)
		{
...
///    
///     <summary> * Checks if the specified vector is within the XZ dimensions of the bounding box. Args: Vec3D </summary>
///     
		private bool isVecInXZ(Vec3 p_72315_1_)
		{
...
///    
///     <summary> * Checks if the specified vector is within the XY dimensions of the bounding box. Args: Vec3D </summary>
///     
		private bool isVecInXY(Vec3 p_72319_1_)
		{
...
///    
///     <summary> * Sets the bounding box to the same bounds as the bounding box passed in. Args: axisAlignedBB </summary>
///     
