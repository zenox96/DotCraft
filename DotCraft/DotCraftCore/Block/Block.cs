...
namespace DotCraftCore.nBlock
{
    ...
    public class Block
    {
        ...
        //		}
        //	};
        protected internal bool opaque;

        /// <summary> How much light is subtracted for going through this block  </summary>
        protected internal int lightOpacity;
        protected internal bool canBlockGrass;

        /// <summary> Amount of light emitted  </summary>
        protected internal int lightValue;
        ...
        public virtual bool func_149730_j( )
        {
            return this.opaque;
        }
        ...
        ///    
        ///     <summary> * Sets the light value that the block emits. Returns resulting block instance for constructing convenience. Args:
        ///     * level </summary>
        ///     
        protected internal virtual Block LightLevel
        {
            set
            {
        ...
        ///    
        ///     <summary> * Sets the the blocks resistance to explosions. Returns the object for convenience in constructing. </summary>
        ///     
        protected internal virtual Block Resistance
        {
            set
            {
                this.blockResistance = value * 3.0F;
                return this;
            }
        }
        ...
        ///     
        protected internal virtual Block TickRandomly
        {
            set
            {
                this.needsRandomTick = value;
                return this;
            }
            get
            {
        ...
        {
            return p_149747_1_.getBlock(p_149747_2_, p_149747_3_, p_149747_4_).Material.Solid;
        }
        ...
        ///    
        ///     <summary> * Returns the block texture based on the side being looked at.  Args: side </summary>
        ///     
        public IIcon getBlockTextureFromSide(int p_149733_1_)
        {
        ...
        public virtual float AmbientOcclusionLightValue
        {
            get
            {
                return this.BlockNormalCube ? 0.2F : 1.0F;
            }
        }
        ...
        public virtual Block CreativeTab
        {
            set
            {
                this.displayOnCreativeTab = value;
                return this;
            }
        }
