...
namespace DotCraftCore.Block
{
	...
	public abstract class BlockRailBase : Block
	{
		...
		public static bool func_150051_a(Block p_150051_0_)
		{
		...
		protected internal BlockRailBase(bool p_i45389_1_) : base(Material.circuits)
		{
		...
		public class Rail
		{
			...
			private void func_150651_b()
			{
				for (int var1 = 0; var1 < this.field_150657_g.Count; ++var1)
				{
					...
					{
						this.field_150657_g[var1] = new ChunkPosition(var2.field_150661_c, var2.field_150658_d, var2.field_150659_e);
					}
					else
					{
			...
			private bool func_150646_a(int p_150646_1_, int p_150646_2_, int p_150646_3_)
			{
			...
			private bool func_150652_b(int p_150652_1_, int p_150652_2_, int p_150652_3_)
			{
			...
			private bool func_150649_b(BlockRailBase.Rail p_150649_1_)
			{
				return this.func_150653_a(p_150649_1_) ? true : (this.field_150657_g.Count == 2 ? false : (this.field_150657_g.Count == 0 ? true : true));
			}
			...
			private void func_150645_c(BlockRailBase.Rail p_150645_1_)
			{
				...
				bool var2 = this.func_150652_b(this.field_150661_c, this.field_150658_d, this.field_150659_e - 1);
				bool var3 = this.func_150652_b(this.field_150661_c, this.field_150658_d, this.field_150659_e + 1);
				bool var4 = this.func_150652_b(this.field_150661_c - 1, this.field_150658_d, this.field_150659_e);
				bool var5 = this.func_150652_b(this.field_150661_c + 1, this.field_150658_d, this.field_150659_e);
				sbyte var6 = -1;
			...
			private bool func_150647_c(int p_150647_1_, int p_150647_2_, int p_150647_3_)
			{
			...
			public virtual void func_150655_a(bool p_150655_1_, bool p_150655_2_)
			{
				...
				bool var5 = this.func_150647_c(this.field_150661_c - 1, this.field_150658_d, this.field_150659_e);
				bool var6 = this.func_150647_c(this.field_150661_c + 1, this.field_150658_d, this.field_150659_e);
				sbyte var7 = -1;
