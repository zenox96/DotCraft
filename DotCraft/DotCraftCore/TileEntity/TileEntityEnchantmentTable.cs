	...
	public class TileEntityEnchantmentTable : TileEntity
	{
		...
		public override void updateEntity()
		{
			...
			if(var1 != null)
			{
				...
				if(this.field_145930_m < 0.5F || field_145923_r.Next(40) == 0)
				{
					float var6 = this.field_145932_k;

					do
					{
						this.field_145932_k += (float)(field_145923_r.Next(4) - field_145923_r.Next(4));
					}
