namespace DotCraftCore.nPathfinding
{
	...
	{
	/// <summary> Used to find obstacles  </summary>
		private IBlockAccess worldMap;

	/// <summary> The path being generated  </summary>
		private Path path = new Path();

	/// <summary> The points in the path  </summary>
		private IntHashMap pointMap = new IntHashMap();

	/// <summary> Selection of path points to add to the path  </summary>
		private PathPoint[] pathOptions = new PathPoint[32];

	/// <summary> should the PathFinder go through wodden door blocks  </summary>
		private bool isWoddenDoorAllowed;

///    
///     <summary> * should the PathFinder disregard BlockMovement type materials in its path </summary>
///     
...
///    
///     <summary> * Creates a path from one entity to another within a minimum distance </summary>
///     
		public virtual PathEntity createEntityPathTo(Entity p_75856_1_, Entity p_75856_2_, float p_75856_3_)
		{
			return this.createEntityPathTo(p_75856_1_, p_75856_2_.posX, p_75856_2_.boundingBox.minY, p_75856_2_.posZ, p_75856_3_);
		}

///    
///     <summary> * Creates a path from an entity to a specified location within a minimum distance </summary>
///     
		public virtual PathEntity createEntityPathTo(Entity p_75859_1_, int p_75859_2_, int p_75859_3_, int p_75859_4_, float p_75859_5_)
		{
...
///    
///     <summary> * Internal implementation of creating a path from an entity to a point </summary>
///     
		private PathEntity createEntityPathTo(Entity p_75857_1_, double p_75857_2_, double p_75857_4_, double p_75857_6_, float p_75857_8_)
		{
			...
			bool var9 = this.isPathingInWater;
			int var10 = MathHelper.floor_double(p_75857_1_.boundingBox.minY + 0.5D);

			if (this.canEntityDrown && p_75857_1_.InWater)
			{
...
///    
///     <summary> * Adds a path from start to end and returns the whole path (args: unused, start, end, unused, maxDistance) </summary>
///     
		private PathEntity addToPath(Entity p_75861_1_, PathPoint p_75861_2_, PathPoint p_75861_3_, PathPoint p_75861_4_, float p_75861_5_)
		{
			...
			while (!this.path.PathEmpty)
			{
				...
				for (int var9 = 0; var9 < var8; ++var9)
				{
					...
					if (!var10.Assigned || var11 < var10.totalPathDistance)
					{
						var10.previous = var7;
...
///    
///     <summary> * populates pathOptions with available points and returns the number of options found (args: unused1, currentPoint,
///     * unused2, targetPoint, maxDistance) </summary>
///     
...
///    
///     <summary> * Returns a point that the entity can safely move to </summary>
///     
			...
			else
			{
				...
				if (var7 != null)
				{
					...
					while (p_75858_3_ > 0)
					{
						...
						if (var9++ >= p_75858_1_.MaxSafePointTries)
						{
							return null;
						}
...
///    
///     <summary> * Returns a mapped point or creates and adds one </summary>
///     
		private PathPoint openPoint(int p_75854_1_, int p_75854_2_, int p_75854_3_)
		{
...
///    
///     <summary> * Checks if an entity collides with blocks at a position. Returns 1 if clear, 0 for colliding with any solid block,
///     * -1 for water(if avoiding water) but otherwise clear, -2 for lava, -3 for fence, -4 for closed trapdoor, 2 if
///     * otherwise clear except for open trapdoor or water(if not avoiding) </summary>
///     
		public virtual int getVerticalOffset(Entity p_75855_1_, int p_75855_2_, int p_75855_3_, int p_75855_4_, PathPoint p_75855_5_)
		{
		...
		public static int func_82565_a(Entity p_82565_0_, int p_82565_1_, int p_82565_2_, int p_82565_3_, PathPoint p_82565_4_, bool p_82565_5_, bool p_82565_6_, bool p_82565_7_)
		{
			bool var8 = false;
				...
				for (int var10 = p_82565_2_; var10 < p_82565_2_ + p_82565_4_.yCoord; ++var10)
				{
					for (int var11 = p_82565_3_; var11 < p_82565_3_ + p_82565_4_.zCoord; ++var11)
					{
						...
						if (var12.Material != Material.air)
						{
							...
							int var13 = var12.RenderType;

							if (p_82565_0_.worldObj.getBlock(var9, var10, var11).RenderType == 9)
							{
								...
								if (p_82565_0_.worldObj.getBlock(var17, var15, var16).RenderType != 9 && p_82565_0_.worldObj.getBlock(var17, var15 - 1, var16).RenderType != 9)
								{
									return -3;
								}
							}
...
///    
///     <summary> * Returns a new PathEntity for a given start and end point </summary>
///     
