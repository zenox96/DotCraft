...
namespace DotCraftCore.nEntity.nProjectile
{
	...
	public abstract class EntityFireball : Entity
	{
...
///     
		...
		public EntityFireball(World p_i1760_1_, double p_i1760_2_, double p_i1760_4_, double p_i1760_6_, double p_i1760_8_, double p_i1760_10_, double p_i1760_12_) : base(p_i1760_1_)
		{
			this.setSize(1.0F, 1.0F);
		...
		public EntityFireball(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_) : base(p_i1761_1_)
		{
...
///     
		protected internal virtual float MotionFactor
		{
			get
			{
				return 0.95F;
...
///     
		protected internal abstract void onImpact(MovingObjectPosition p_70227_1_);
...
///     
		public override void writeEntityToNBT(NBTTagCompound p_70014_1_)
		{
			...
			p_70014_1_.setByte("inTile", (sbyte)Block.getIdFromBlock(this.field_145796_h));
...
///     
		public override bool attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_)
		{
			...
			else
			{
				...
				if (p_70097_1_.Entity != null)
				{
					Vec3 var3 = p_70097_1_.Entity.LookVec;
					...
					if (p_70097_1_.Entity is EntityLivingBase)
					{
						this.shootingEntity = (EntityLivingBase)p_70097_1_.Entity;
					}
