...
namespace DotCraftCore.nBlock
{
	public class BlockPistonBase : Block
	{
		...
		public override void func_150070_b(float p_150070_1_, float p_150070_2_, float p_150070_3_, float p_150070_4_, float p_150070_5_, float p_150070_6_)
		{
...
///     
		...
		private void func_150078_e(World p_150078_1_, int p_150078_2_, int p_150078_3_, int p_150078_4_)
		{
			...
			if (var6 != 7)
			{
				bool var7 = this.func_150072_a(p_150078_1_, p_150078_2_, p_150078_3_, p_150078_4_, var6);
		...
		private bool func_150072_a(World p_150072_1_, int p_150072_2_, int p_150072_3_, int p_150072_4_, int p_150072_5_)
		{
		...
		public override bool onBlockEventReceived(World p_149696_1_, int p_149696_2_, int p_149696_3_, int p_149696_4_, int p_149696_5_, int p_149696_6_)
		{
			...
			{
				bool var7 = this.func_150072_a(p_149696_1_, p_149696_2_, p_149696_3_, p_149696_4_, p_149696_6_);
...
///     
		...
		public static bool func_150075_c(int p_150075_0_)
		{
		...
		private static bool func_150080_a(Block p_150080_0_, World p_150080_1_, int p_150080_2_, int p_150080_3_, int p_150080_4_, bool p_150080_5_)
		{
			...
			else
			{
				if (p_150080_0_ != Blocks.piston && p_150080_0_ != Blocks.sticky_piston)
				{
					...
					if (p_150080_0_.MobilityFlag == 2)
					{
						return false;
					}

					if (p_150080_0_.MobilityFlag == 1)
					{
						if (!p_150080_5_)
						{
							return false;
				...
				return !(p_150080_0_ is ITileEntityProvider);
			}
		}

		private static bool func_150077_h(World p_150077_0_, int p_150077_1_, int p_150077_2_, int p_150077_3_, int p_150077_4_)
		{
		...
		private bool func_150079_i(World p_150079_1_, int p_150079_2_, int p_150079_3_, int p_150079_4_, int p_150079_5_)
		{
