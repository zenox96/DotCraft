...
namespace DotCraftCore.nBlock
{
	...
	{
		public BlockTripWireHook() : base(Material.circuits)
		{
...
///     
		public override void onPostBlockPlaced(World p_149714_1_, int p_149714_2_, int p_149714_3_, int p_149714_4_, int p_149714_5_)
		{
		...
		public override void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
		{
			if (p_149695_5_ != this)
			{
				if (this.func_150137_e(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_))
				{
					...
					if (!p_149695_1_.getBlock(p_149695_2_ - 1, p_149695_3_, p_149695_4_).NormalCube && var7 == 3)
					{
						var8 = true;
					}

					if (!p_149695_1_.getBlock(p_149695_2_ + 1, p_149695_3_, p_149695_4_).NormalCube && var7 == 1)
					{
						var8 = true;
					}

					if (!p_149695_1_.getBlock(p_149695_2_, p_149695_3_, p_149695_4_ - 1).NormalCube && var7 == 0)
					{
						var8 = true;
					}

					if (!p_149695_1_.getBlock(p_149695_2_, p_149695_3_, p_149695_4_ + 1).NormalCube && var7 == 2)
					{
						var8 = true;
					}
		...
		public override void func_150136_a(World p_150136_1_, int p_150136_2_, int p_150136_3_, int p_150136_4_, bool p_150136_5_, int p_150136_6_, bool p_150136_7_, int p_150136_8_, int p_150136_9_)
		{
			int var10 = p_150136_6_ & 3;
			bool var11 = (p_150136_6_ & 4) == 4;
			bool var12 = (p_150136_6_ & 8) == 8;
			bool var13 = !p_150136_5_;
			bool var14 = false;
			bool var15 = !World.doesBlockHaveSolidTopSurface(p_150136_1_, p_150136_2_, p_150136_3_ - 1, p_150136_4_);
			...
			for (var20 = 1; var20 < 42; ++var20)
			{
				...
				else
				{
					...
					bool var25 = (var24 & 8) != 8;
					bool var26 = (var24 & 1) == 1;
					bool var27 = (var24 & 2) == 2;
					var13 &= var27 == var15;
					var14 |= var25 && var26;
					var19[var20] = var24;
...
///     
		...
		private void func_150135_a(World p_150135_1_, int p_150135_2_, int p_150135_3_, int p_150135_4_, bool p_150135_5_, bool p_150135_6_, bool p_150135_7_, bool p_150135_8_)
		{
		...
		private bool func_150137_e(World p_150137_1_, int p_150137_2_, int p_150137_3_, int p_150137_4_)
		{
		...
		{
			bool var7 = (p_149749_6_ & 4) == 4;
			bool var8 = (p_149749_6_ & 8) == 8;
