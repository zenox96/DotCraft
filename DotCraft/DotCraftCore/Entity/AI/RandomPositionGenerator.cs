...
namespace DotCraftCore.Entity.AI
{
	...
	{
///    
///     <summary> * used to store a driection when the user passes a point to move towards or away from. WARNING: NEVER THREAD SAFE.
...
///    
///     <summary> * finds a random target within par1(x,z) and par2 (y) blocks in the direction of the point par3 </summary>
///     
...
///    
///     <summary> * finds a random target within par1(x,z) and par2 (y) blocks in the reverse direction of the point par3 </summary>
///     
...
///    
///     <summary> * searches 10 blocks at random in a within par1(x,z) and par2 (y) distance, ignores those not in the direction of
///     * par3Vec3, then points to the tile for which creature.getBlockPathWeight returns the highest number </summary>
///     
		private static Vec3 findRandomTargetBlock(EntityCreature p_75462_0_, int p_75462_1_, int p_75462_2_, Vec3 p_75462_3_)
		{
			Random var4 = p_75462_0_.RNG;
			bool var5 = false;
			int var6 = 0;
			int var7 = 0;
			int var8 = 0;
			...
			{
				double var11 = (double)(p_75462_0_.HomePosition.getDistanceSquared(MathHelper.floor_double(p_75462_0_.posX), MathHelper.floor_double(p_75462_0_.posY), MathHelper.floor_double(p_75462_0_.posZ)) + 4.0F);
			...
			{
				int var12 = var4.Next(2 * p_75462_1_) - p_75462_1_;
				int var17 = var4.Next(2 * p_75462_2_) - p_75462_2_;
				int var14 = var4.Next(2 * p_75462_1_) - p_75462_1_;
