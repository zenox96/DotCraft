...
namespace DotCraftCore.Entity.Projectile
{
	...
	public class EntityFishHook : Entity
	{
		...
		public EntityFishHook(World p_i1765_1_, double p_i1765_2_, double p_i1765_4_, double p_i1765_6_, EntityPlayer p_i1765_8_) : this(p_i1765_1_)
		{
		...
		public EntityFishHook(World p_i1766_1_, EntityPlayer p_i1766_2_) : base(p_i1766_1_)
		{
			this.field_146037_g = -1;
			this.field_146048_h = -1;
			this.field_146050_i = -1;
...
///     
		...
		public virtual void func_146035_c(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_, float p_146035_8_)
		{
						...
						else
						{
							...
							else if (this.field_146040_ay > 0)
							{
								...
								if (this.rand.nextFloat() < var15)
								{
									...
									var35.func_147487_a("splash", var38, var20, var22, 2 + this.rand.Next(2), 0.10000000149011612D, 0.0D, 0.10000000149011612D, 0.0D);
								}
...
///     
		public override void writeEntityToNBT(NBTTagCompound p_70014_1_)
		{
			...
			p_70014_1_.setByte("inTile", (sbyte)Block.getIdFromBlock(this.field_146046_j));
			p_70014_1_.setByte("shake", (sbyte)this.field_146044_a);
			p_70014_1_.setByte("inGround", (sbyte)(this.field_146051_au ? 1 : 0));
		}
...
///     
		...
		public virtual int func_146034_e()
		{
			if (this.worldObj.isClient)
			{
				return 0;
			...
			else
			{
				...
				else if (this.field_146045_ax > 0)
				{
					...
					this.field_146042_b.worldObj.spawnEntityInWorld(new EntityXPOrb(this.field_146042_b.worldObj, this.field_146042_b.posX, this.field_146042_b.posY + 0.5D, this.field_146042_b.posZ + 0.5D, this.rand.Next(6) + 1));
					var1 = 1;
				}
