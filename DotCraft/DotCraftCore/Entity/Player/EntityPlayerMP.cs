...
namespace DotCraftCore.nEntity.nPlayer
{
	...
	using ContainerBeacon = DotCraftCore.nInventory.ContainerBeacon;
	using ContainerBrewingStand = DotCraftCore.nInventory.ContainerBrewingStand;
	using ContainerChest = DotCraftCore.nInventory.ContainerChest;
	using ContainerDispenser = DotCraftCore.nInventory.ContainerDispenser;
	using ContainerEnchantment = DotCraftCore.nInventory.ContainerEnchantment;
	using ContainerFurnace = DotCraftCore.nInventory.ContainerFurnace;
	using ContainerHopper = DotCraftCore.nInventory.ContainerHopper;
	using ContainerHorseInventory = DotCraftCore.nInventory.ContainerHorseInventory;
	using ContainerMerchant = DotCraftCore.nInventory.ContainerMerchant;
	using ContainerRepair = DotCraftCore.nInventory.ContainerRepair;
	using ContainerWorkbench = DotCraftCore.nInventory.ContainerWorkbench;
	using ICrafting = DotCraftCore.nInventory.ICrafting;
	using IInventory = DotCraftCore.nInventory.IInventory;
	using InventoryMerchant = DotCraftCore.nInventory.InventoryMerchant;
	using SlotCrafting = DotCraftCore.nInventory.SlotCrafting;
	using EnumAction = DotCraftCore.nItem.EnumAction;
	using ItemMapBase = DotCraftCore.nItem.ItemMapBase;
	using ItemStack = DotCraftCore.nItem.ItemStack;
	using NBTTagCompound = DotCraftCore.nNBT.NBTTagCompound;
	using NetHandlerPlayServer = DotCraftCore.nNetwork.NetHandlerPlayServer;
	...
	using UserListOpsEntry = DotCraftCore.nServer.nManagement.UserListOpsEntry;
	...
	using StatisticsFile = DotCraftCore.nStats.StatisticsFile;
