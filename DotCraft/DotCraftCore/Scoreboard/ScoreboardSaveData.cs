...
namespace DotCraftCore.Scoreboard
{
	...
	public class ScoreboardSaveData : WorldSavedData
	{
		...
		public ScoreboardSaveData(string p_i2310_1_) : base(p_i2310_1_)
		{
		}

		public virtual void func_96499_a(Scoreboard p_96499_1_)
		{
...
///     
		...
		protected internal virtual void func_96498_a(NBTTagList p_96498_1_)
		{
			for(int var2 = 0; var2 < p_96498_1_.tagCount(); ++var2)
			{
				...
				var4.TeamName = var3.getString("DisplayName");
				var4.NamePrefix = var3.getString("Prefix");
				var4.NameSuffix = var3.getString("Suffix");

				if(var3.func_150297_b("AllowFriendlyFire", 99))
				{
					var4.AllowFriendlyFire = var3.getBoolean("AllowFriendlyFire");
				}

				if(var3.func_150297_b("SeeFriendlyInvisibles", 99))
				{
					var4.SeeFriendlyInvisiblesEnabled = var3.getBoolean("SeeFriendlyInvisibles");
				}
		...
		protected internal virtual void func_96502_a(ScorePlayerTeam p_96502_1_, NBTTagList p_96502_2_)
		{
			for(int var3 = 0; var3 < p_96502_2_.tagCount(); ++var3)
			{
				this.theScoreboard.func_151392_a(p_96502_2_.getStringTagAt(var3), p_96502_1_.RegisteredName);
			}
		}

		protected internal virtual void func_96504_c(NBTTagCompound p_96504_1_)
		{
		...
		protected internal virtual void func_96501_b(NBTTagList p_96501_1_)
		{
			for(int var2 = 0; var2 < p_96501_1_.tagCount(); ++var2)
			{
				...
				var5.DisplayName = var3.getString("DisplayName");
			}
		}

		protected internal virtual void func_96500_c(NBTTagList p_96500_1_)
		{
...
///     
		...
		protected internal virtual NBTTagList func_96496_a()
		{
			NBTTagList var1 = new NBTTagList();
			ICollection var2 = this.theScoreboard.Teams;
			IEnumerator var3 = var2.GetEnumerator();

			while(var3.MoveNext())
			{
				ScorePlayerTeam var4 = (ScorePlayerTeam)var3.Current;
				NBTTagCompound var5 = new NBTTagCompound();
				var5.setString("Name", var4.RegisteredName);
				var5.setString("DisplayName", var4.func_96669_c());
				var5.setString("Prefix", var4.ColorPrefix);
				var5.setString("Suffix", var4.ColorSuffix);
				var5.setBoolean("AllowFriendlyFire", var4.AllowFriendlyFire);
				var5.setBoolean("SeeFriendlyInvisibles", var4.func_98297_h());
				NBTTagList var6 = new NBTTagList();
				IEnumerator var7 = var4.MembershipCollection.GetEnumerator();
		...
		protected internal virtual void func_96497_d(NBTTagCompound p_96497_1_)
		{
			...
			for(int var4 = 0; var4 < 3; ++var4)
			{
				...
				if(var5 != null)
				{
					var2.setString("slot_" + var4, var5.Name);
					var3 = true;
				}
			}
		...
		protected internal virtual NBTTagList func_96505_b()
		{
			NBTTagList var1 = new NBTTagList();
			ICollection var2 = this.theScoreboard.ScoreObjectives;
			IEnumerator var3 = var2.GetEnumerator();
			...
			while(var3.MoveNext())
			{
				...
				NBTTagCompound var5 = new NBTTagCompound();
				var5.setString("Name", var4.Name);
				var5.setString("CriteriaName", var4.Criteria.func_96636_a());
				var5.setString("DisplayName", var4.DisplayName);
				var1.appendTag(var5);
			}
		...
		protected internal virtual NBTTagList func_96503_e()
		{
			NBTTagList var1 = new NBTTagList();
			ICollection var2 = this.theScoreboard.func_96528_e();
			IEnumerator var3 = var2.GetEnumerator();

			while(var3.MoveNext())
			{
				Score var4 = (Score)var3.Current;
				NBTTagCompound var5 = new NBTTagCompound();
				var5.setString("Name", var4.PlayerName);
				var5.setString("Objective", var4.func_96645_d().Name);
				var5.setInteger("Score", var4.ScorePoints);
				var1.appendTag(var5);
			}
