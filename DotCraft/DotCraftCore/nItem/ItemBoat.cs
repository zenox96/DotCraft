...
///     
		public virtual ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_)
		{
			...
			else
			{
				...
				bool var26 = false;
				float var27 = 1.0F;
				IList var28 = p_77659_2_.getEntitiesWithinAABBExcludingEntity(p_77659_3_, p_77659_3_.boundingBox.addCoord(var25.xCoord * var21, var25.yCoord * var21, var25.zCoord * var21).expand((double)var27, (double)var27, (double)var27));
				int var29;

				for (var29 = 0; var29 < var28.Count; ++var29)
				{
					Entity var30 = (Entity)var28[var29];

					if (var30.canBeCollidedWith())
					{
						float var31 = var30.CollisionBorderSize;
				...
				else
				{
					if (var24.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
					{
						...
						if (!p_77659_2_.getCollidingBoundingBoxes(var35, var35.boundingBox.expand(-0.1D, -0.1D, -0.1D)).Empty)
						{
							return p_77659_1_;
						}
