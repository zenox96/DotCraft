...
namespace DotCraftCore.nItem
{
	...
	/// <summary> If true, render the object in full 3D, like weapons and tools.  </summary>
		protected internal bool bFull3D;

///    
///     <summary> * Some items (like dyes) have multiple subtypes on same item, this is field define this behavior </summary>
///     
	...
	/// <summary> The string associated with this Item's Icon.  </summary>
		...
		public static void registerItems()
		{
			...
			itemRegistry.addObject(321, "painting", (new ItemHangingEntity(typeof(EntityPainting))).setUnlocalizedName("painting").setTextureName("painting"));
			...
			itemRegistry.addObject(389, "item_frame", (new ItemHangingEntity(typeof(EntityItemFrame))).setUnlocalizedName("frame").setTextureName("item_frame"));
			...
			IEnumerator var2 = Block.blockRegistry.Keys.GetEnumerator();
...
///    
///     <summary> * Returns the icon index of the stack given as argument. </summary>
///     
		public IIcon getIconIndex(ItemStack p_77650_1_)
		{
			return this.getIconFromDamage(p_77650_1_.ItemDamage);
		}
...
///    
///     <summary> * set max damage of an Item </summary>
///     
...
///    
///     <summary> * Sets bFull3D to True and return the object. </summary>
///     
...
///     
		public virtual bool doesContainerItemLeaveCraftingGrid(ItemStack p_77630_1_)
		{
			return true;
		}
...
///    
///     <summary> * True if this Item has a container item (a.k.a. crafting result) </summary>
///     
...
///     
		...
		{
			return p_77636_1_.ItemEnchanted;
		}
...
///     
		...
		{
			return p_77613_1_.ItemEnchanted ? EnumRarity.rare : EnumRarity.common;
		}
...
///    
///     <summary> * Returns true if players can use this item to affect the world (e.g. placing blocks, placing ender eyes in portal)
///     * when not in creative </summary>
///     
...
///    
///     <summary> * Returns the string associated with this Item's Icon. </summary>
///     
		protected internal virtual string IconString
		{
			get
			{
